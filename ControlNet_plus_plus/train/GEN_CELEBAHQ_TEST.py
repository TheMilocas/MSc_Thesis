"""
===========================================================
ControlNet vs Base Stable Diffusion Inpainting on Eyes-Masked CelebA-HQ
===========================================================

Purpose:
    Generate inpainted images from eyes-masked CelebA-HQ images 
    using both the base Stable Diffusion inpainting pipeline and 
    ControlNet-guided inpainting with identity embeddings.

Inputs:
    - Masked face images: `MASKED_IMAGE_PATH`
    - Eye mask: `MASK_DIR`
