"""
===========================================================
Base Stable Diffusion Inpainting on Masked Face Images
===========================================================

Purpose:
    Perform inpainting on masked face images using the base 
    Stable Diffusion inpainting pipeline without ControlNet 
    guidance.
...
Inputs:
    ...
    - Pretrained base Stable Diffusion inpainting model: 
      "runwayml/stable-diffusion-inpainting"

Outputs:
    - Inpainted images using the base Stable Diffusion pipeline, 
      saved in `SAVE_DIR` with filenames corresponding to the 
