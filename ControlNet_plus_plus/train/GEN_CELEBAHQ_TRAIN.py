"""
===========================================================
ControlNet vs Base SD Inpainting on Eyes-Masked CelebA-HQ (Train Set)
===========================================================

Purpose:
    Generate inpainted images from eyes-masked CelebA-HQ training images
    using both the base Stable Diffusion inpainting pipeline and 
    ControlNet-guided inpainting with identity embeddings.

Inputs:
    - Masked training images: `MASKED_IMAGE_PATH`
    - Eye mask: `MASK_DIR`
    - Identity embeddings: `EMBEDDING_PREFIX`
